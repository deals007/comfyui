...
RUN pip install accelerate safetensors huggingface-hub pillow einops opencv-python
...
RUN pip install -r /app/ComfyUI/custom_nodes/ComfyUI_IPAdapter_plus/requirements.txt || true
